...
module Vec
  ...
  -- std::vector with optional backtracking
  , Vector(..)
  , newVector
  , nonAtomicModifyVector
  , modifyVector
  , addVector
  , subVector
  , readVector
...
-- |
-- Plays the role of std::vector, non-transient non-thread-safe version
--
-- The following operations are backtracking-safe
--
-- @
-- newVector
-- readVector
